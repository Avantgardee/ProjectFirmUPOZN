...
procedure TFormMain.EmpListExecute(Sender: TObject);
    ...
    TempList: TTasksList;
Begin
    TempList := TTasksList.Create;

    TempList := FormMain.WorkList.FindProjectsByDate;
    ...
    begin
        ...
        case MessageBox(WND, lpText, lpCaption, Tip) Of
            ...
            begin
                ...
                begin
                    ListForm.PanelBtn.Visible := True;
                    ListForm.strgrdList.ColCount := 6;
                ...
                begin
                    ListForm.PanelBtn.Visible := True;
                    ListForm.strgrdList.ColCount := 5;
                    ListForm.SaveExecute(Sender);
                end
                else
